...
| **webnavigator** | Maneja su propio navegador para hacer en un sitio lo que le pidas: buscar, entrar con tu sesión, rellenar un formulario, ir pasando páginas y contarte lo que encontró. |

`webnavigator` es el único sin programación horaria: trabaja cuando se lo pides
...
| **Night High Contrast** | Fondo casi negro, texto claro, bordes duros. Aquí nada se rellena con el color de acento: el cuadro de cada agente en la barra lateral y el mensaje que has enviado son contornos, y tu propio mensaje va relleno de un blanco apagado en vez de azul |
