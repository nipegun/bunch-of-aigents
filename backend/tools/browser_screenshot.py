...
cToolDescription = (
  "Save a picture of the page open in your browser. You will not be able to "
  "see it - it is for the user - so say in your answer where you put it and "
  "what it shows. Useful when you cannot explain what a page is doing."
)
...
def fRunTool(pArguments, pContext):
  ...
  return ("Saved to %s. You cannot see it; tell the user it is there and what "
          "is in it." % (vPath,))
