...
class OpenAiProvider(base.BaseProvider):
  ...
  # gpt-4o is not served any more. Its replacement here is the CHEAPEST model
  # of the current generation: an agent on a cron schedule nobody watches is
  # the easiest way to run up a bill, and the bigger models are one click away
  # in the LLM tab, with their price shown. gpt-5-mini was the small one but
  # not the smallest - gpt-5-nano is five times cheaper on input.  #
