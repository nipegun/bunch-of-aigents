/* Settings > Tools: what is installed on the server.
 *
 ...
 * (`/settings/?tab=tools&family=mail`), like every other set of tabs in the application:
...
async function fRenderTools() {
  ...
  const dResult = await fCallApi("/tools");
